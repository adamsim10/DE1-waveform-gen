...
REM
REM Generated by Vivado on Wed Apr 15 17:46:32 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_FreqToPhase_vhdl.prj"
call xvhdl  --incr --relax -prj tb_FreqToPhase_vhdl.prj -log xvhdl.log
