...
REM
REM Generated by Vivado on Thu Apr 23 17:07:41 +0200 2026
...
echo "xvhdl --incr --relax -prj cfg_tb_parameter_vhdl.prj"
call xvhdl  --incr --relax -prj cfg_tb_parameter_vhdl.prj -log xvhdl.log
