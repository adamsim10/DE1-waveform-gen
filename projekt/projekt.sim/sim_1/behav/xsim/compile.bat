...
REM
REM Generated by Vivado on Wed Apr 15 19:33:53 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_SAW_W_vhdl.prj"
call xvhdl  --incr --relax -prj tb_SAW_W_vhdl.prj -log xvhdl.log
