...
REM
REM Generated by Vivado on Wed Apr 08 10:03:01 +0200 2026
...
echo "xvhdl --incr --relax -prj display_driver_tb_vhdl.prj"
call xvhdl  --incr --relax -prj display_driver_tb_vhdl.prj -log xvhdl.log
